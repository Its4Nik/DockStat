...
export type Mixin<
	...
	R extends Constructor = Constructor,
> = (Base: C) => R
...
export type EventMessage<K extends keyof EVENTS = keyof EVENTS> =
...
export const isInitCompleteMessage = (
	msg: unknown
): msg is InitCompleteMessage => {
	return (
		typeof msg === "object" &&
		msg !== null &&
...
export const isInternalWorkerMessage = (
	msg: unknown
): msg is InternalWorkerMessage => {
	return (
		typeof msg === "object" &&
		msg !== null &&
		((msg as Record<string, unknown>).type === "__init_complete__" ||
...
export const isWorkerResponse = <T = unknown>(
	msg: unknown
...
export const isProxyEventEnvelope = (
	payload: unknown
): payload is ProxyEventEnvelope => {
	const p = payload as Record<string, unknown>
	return (
		typeof payload === "object" &&
		payload !== null &&
		(p.type === "__event__" ||
			p.type === "__init_complete__" ||
			p.type === "__metrics__") &&
...
export const looksLikeEventMessage = (
	payload: unknown
