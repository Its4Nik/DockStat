...
updatedAt: 2026-01-01T15:02:00.872Z
urlId: mok9JVXj9w
---
...
- Response:
  - On success:
    ...
    ```json
    {
      ...
      "template": {
        /* template object (builder / parsed JSON/YAML) */
      },
      "fragments": {
        /* shared fragments keyed by fragment id */
      },
      "loaders": [
        /* loader definitions for this route */
      ],
      "actions": [
        /* action definitions for this route */
      ],
      "initialData": {
        "loaderResults": [
          /* results for each loader executed */
        ],
        "state": {
          /* merged state as returned from loaders */
        },
        "data": {
          /* additional data returned by loaders */
        }
      }
    }
    ```
