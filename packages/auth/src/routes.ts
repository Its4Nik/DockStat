  ...
  return new Elysia({ prefix: "/auth", detail: { tags: ["Auth"] } })
    ...
    .get(
      ...
      },
      {
        ...
        detail: {
          summary: "Logout",
          description: "Logout of the Provider which matches the Provider ID from the DB. If a logout_url is defined for the Provider it will use that, otherwise build it from the OIDC-Metadata of the provider"
        }
      }
    )
}
