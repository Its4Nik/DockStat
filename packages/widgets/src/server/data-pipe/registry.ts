...
export type FieldType = "string" | "number" | "boolean" | "select" | "textarea" | "object"
...
export const NODE_TEMPLATES: NodeTemplateDef[] = [
  ...
  },
  {
    ...
    properties: [
      ...
      {
        default: { value: "sum" },
        description: "JSON object mapping field to operation (sum, avg, min, max, count, first, last)",
        key: "aggregations",
        label: "Aggregations",
        type: "object",
      },
  ...
  {
    description: "Flattens nested arrays. Optionally plucks a nested array field from each record.",
    hasSource: true,
    hasTarget: true,
  ...
  {
    description: "Renames or restructures fields on each record. Supports dot-notation for nesting.",
    hasSource: true,
    hasTarget: true,
    ...
    properties: [
      {
        ...
        description: "JSON object mapping old field name to new field name (e.g. { meta.title: title })",
        key: "mapping",
        label: "Field Mapping",
        type: "object",
      },
